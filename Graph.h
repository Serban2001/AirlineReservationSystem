...
class Graph {
	...
	int minimum(costInfo array[], bool set[])
	{
		double min = 99999999;
		int min_index = 0;
	...
	ListNode* getChildLocation(string src, int dest)
	{
	...
	double getMinimumFlightRate(Vector<Flight>& flight, string& date, string src, string desti, Time time, string airline)
	{
		Flight temp;
		double min = 99999999;
	...
	double getMinimumFlightTime(Vector<Flight>& flight, string& date, string src, string desti, Time time)
	{
		Flight temp;
		double min = 99999999;
		for (int i = 0; i < flight.Size(); i++) {
	...
	Flight getMinimumFlightT(Vector<Flight>& flight, string& date, string src, string desti, Time time)
	{
		Flight temp;
		double min = 99999999;
	...
	Flight getMinimumFlight(Vector<Flight>& flight, string& date, string src, string desti, Time time, string airline)
	{
		Flight temp;
		double min = 99999999;
...
public:
	...
	void direct_traversal(string sour, string dest, string date, string airline) {
		bool check = false;
	...
	void connected_traversal(string sour, string trans, string dest, string date) {
		int check = 0;
		int i = getVertix_num(sour);
		if (i == -1) {
			cout << "\t\t\t\t\tOrigin city not found. ";
			...
			if (temp->destination == trans) {
				...
				for (int k = 0; k < temp->flight.Size(); k++) {
					if (date == temp->flight[k].getDate_string()) {
						...
						cout << "\t-----------------------------------------------------------------------------------------------" << endl;
						str = temp->flight[k].getDay_of_Flight();
						str1 = temp->flight[k].getFlyingTime();
	...
	void transit_time(string sour, string trans, string dest, int t_hour, string date) {
		int check = 0;
		int i = getVertix_num(sour);
		if (i == -1) {
			cout << "\t\t\t\t\tOrigin city not found. ";
	...
	costInfo* dijkstra(string src, string date, string airline) {
	...
	costInfo* MinimumTimeQuery(string src, string date)
	{
	...
	void findMinTimePath(string src, string desti, string date) {
	...
	void findMinCostPath(string src, string desti, string date, string airline) {
